// Экспорт констант маршрутов для использования в приложении
export const ADMIN_ROUTE = '/admin' // Маршрут к странице админа
export const LOGIN_ROUTE = '/login' // Маршрут к странице входа
